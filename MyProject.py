...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\alexs\\OneDrive\\Desktop\\MYP\\MyProject.py',
...
text_instructions = visual.TextStim(win=win, name='text_instructions',
    text="Please read the instructions carefully.\n\nIn this experiment, you are asked to complete 2 steps over multiple trials.\nEach trial has the same steps to complete. \n\nThe aim of this experiment is for you to decide whether the suspect and the offender on the recordings are the same or different speakers. \n\nIn step 1: listen to Offender Recording and Suspect Recording. You can listen to the recordings as much as you want.\n\nOnce you have familiarised yourself with the recordings, please go to step 2.\n\nIn step 2: please answer as to what degree you think that the suspect is OR isn't the offender based on what you have listened. You MUST select ONE answer in order to move to the next trial.\n\nOnce you have selected an answer, please move to the next trial. \n\nAfter you have finished all the trials, you will see the message 'Thank you for your participation'. \n",
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
